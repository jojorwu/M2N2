...
class TestDataDeterminism(unittest.TestCase):
    ...
    def test_validation_split_is_deterministic_with_seed(self):
        ...
        _, validation_loader_1, _, _, _ = get_dataloaders(
        ...
        _, validation_loader_2, _, _, _ = get_dataloaders(
            dataset_name='CIFAR10',
            subset_percentage=0.1,
            validation_split=0.5,
            seed=seed
    ...
    def test_validation_set_is_correctly_filtered_for_niche(self):
        ...
        _, validation_loader, _, _, _ = get_dataloaders(
            dataset_name='CIFAR10',
    ...
    def test_train_loader_shuffle_is_deterministic_with_seed(self):
        ...
        # Act
        train_loader_1, _, _, _, _ = get_dataloaders(
            dataset_name='CIFAR10',
            subset_percentage=0.1,
            seed=seed
        )
        train_loader_2, _, _, _, _ = get_dataloaders(
            dataset_name='CIFAR10',
            subset_percentage=0.1,
            seed=seed
        )
