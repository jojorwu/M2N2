...
class TestEvolution(unittest.TestCase):
    ...
    def test_select_mates_handles_multiple_weakest_classes(self, mock_evaluate_by_class):
        ...
        for _ in range(30):
            _, parent2 = select_mates(population, dataset_name='CIFAR10', test_loader=None)
    ...
    def test_create_next_generation_avoids_duplicates(self):
        ...
        # Act
        next_gen = create_next_generation(population, duplicate_child, population_size, 'CIFAR10', test_loader=None)
